...
import { handleRicPaymentRoute } from "./ric-payment-routes.js";
...
export async function handlePosboxRoute(req:IncomingMessage,res:ServerResponse,u:URL,account:RicAccount|undefined):Promise<boolean>{
 ...
 // Shared durable QR/NFC send checkout. Core money modules remain unchanged.
 if(await handleRicPaymentRoute(req,res,u,account))return true;
